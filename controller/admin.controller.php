...
if (!isset($_GET['p'])) {
    ...
    switch ($_GET['p']) {
        ...
        case 'delete.shop.admin':
            ...
            break;
        case 'read.shop.admin':
            include dirname(__DIR__) . DIRECTORY_SEPARATOR . 'controller' . DIRECTORY_SEPARATOR . 'admin' . DIRECTORY_SEPARATOR . 'shop' . DIRECTORY_SEPARATOR . 'read.shop.admin.controller.php';
            break;
