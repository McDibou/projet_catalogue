<form method="post">
    ...
    <input name="promo_article" type="text" value="<?= $view_modify['promo_article'] ?>" placeholder="promo">
    <p><?= $view_modify['date_promo_article'] ?></p>
    <input name="date_promo" type="text" placeholder="date promo">
